...
class BandImage(BaseModel):
    ...
    `visual_text`/`ocr_text` existem para fixtures determinísticos no MVP. Em produção, o
    embedding vem da imagem (Voyage multimodal) e `ocr_text` é preenchido pelo OCRProvider.
    """
